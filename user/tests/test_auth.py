...
class AuthenticationTest(TestCase):
    ...
    def test_user_will_be_authenticated(self):
        User.objects.create_user(username = "username1", password = "password1", email = "email1@example.com")
        self.assertNotEqual(authenticate(username = "username1", password = "password1"), None)
